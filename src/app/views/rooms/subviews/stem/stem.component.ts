...
export class RoomsSTEMComponent implements OnInit {
    ...
    constructor(private meta: Meta, private title: Title) {
        ...
        this.meta.updateTag({name: 'keywords', content: 'mind thrill,mind thrill escape rooms,escape rooms,mackinaw city,mackinaw escape,fun things to do,challenging, group activity,date night,corporate team building,all ages,family,sci-fi'});
    }
